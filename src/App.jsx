...
import SubjectDetailPage from './pages/SubjectDetailPage'; // --- AÑADIDO ---
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        {/* --- NUEVA RUTA DINÁMICA AÑADIDA --- */}
        <Route path="/subject/:id" element={session ? <SubjectDetailPage /> : <Navigate to="/login" />} />
